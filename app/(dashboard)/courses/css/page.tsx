...
import { cssChapters, levels } from "@/app/component/data/cssData";
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-100 via-white to-gray-200 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-6 flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-800">CSS Complete Course</h1>
            <p className="text-gray-500 text-sm mt-1">
              {cssChapters.length} chapters • 2 levels • Beginner to Intermediate
            </p>
          </div>
        </div>
        ...
        {levels.map(({ level, name, icon, color, chapters }) => {
          const levelChapters = cssChapters.filter((c) => c.level === level);
